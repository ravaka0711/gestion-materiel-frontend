...
const MaintenancePage = () => {
  ...
  useEffect(() => {
    ...
    // Filtre par plage de dates (basé sur date_debut)
...
<div className="bg-white dark:bg-gray-800/50 rounded-lg p-3 mb-3 border border-gray-200 dark:border-gray-700 flex-shrink-0">
  <div className="flex flex-col gap-3">
    ...
    {/* Ligne principale : Recherche | Filtres dates (milieu) | Actualiser (droite) */}
    <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-3">
      ...
      {/* Filtres par dates au milieu - flex-1 pour prendre l'espace disponible */}
    ...
    {/* Ligne secondaire : Filtres status et type */}
