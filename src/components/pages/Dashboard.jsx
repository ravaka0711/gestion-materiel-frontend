...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      {/* Styles pour personnaliser le scrollbar */}
      <style>{`
        ...
        /* Pour le mode sombre */
        .dark .w-full::-webkit-scrollbar-track {
          background: #1e293b;
        }
        ...
        .dark .w-full::-webkit-scrollbar-thumb:hover {
          background: #94a3b8;
        }
      `}</style>
      ...
      <div className="px-6 py-3">
        ...
        <h2 className="text-2xl font-bold dark:text-white mb-6">Tableau de bord</h2>
